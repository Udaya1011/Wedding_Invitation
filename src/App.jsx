...
const EnvelopeScreen = ({ onOpen, onDownload }) => {
...
function App() {
  ...
  const calendarEvent = {
    ...
    start: '20260625T123000Z',
    end: '20260625T163000Z',
  };
  ...
  useEffect(() => {
    ...
    const weddingDate = new Date('2026-06-25T18:00:00+05:30');
  ...
  return (
    <div className="bg-black min-h-screen text-[var(--color-silver)] font-sans relative overflow-x-hidden z-10">
      <AnimatePresence>
        {showEnvelope && <EnvelopeScreen onOpen={() => setShowEnvelope(false)} onDownload={triggerDownload} />}
      </AnimatePresence>
        ...
        <div className="z-10 flex flex-col items-center mt-10">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-serif leading-none tracking-tight flex flex-col items-center mb-6">
              <span className="text-silver-gradient">Sounder</span>
              <Heart className="w-8 h-8 text-[#cd96a7] fill-[#000000] my-3 drop-shadow-lg" />
              <span className="text-silver-gradient">Sowndharya</span>
            </h1>
            <p className="tracking-[0.4em] text-xs md:text-sm uppercase text-white/40 mb-10">Are Getting Married</p>
            <div className="mt-6 w-full max-w-xl mx-auto">
              ...
              <p className="text-[10px] uppercase tracking-[0.3em] text-white/40 mt-4">25 June 2026 • 6:00 PM - 10:00 PM</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mt-16">
            ...
            <div className="silver-border p-8 glass-panel group">
              ...
              <p className="text-xl md:text-2xl font-serif text-white group-hover:text-silver-gradient transition-colors">6:00 PM<br/>10:00 PM</p>
            </div>
      ...
      <div style={{ position: 'absolute', top: '-9999px', left: '-9999px', width: '800px', height: '1200px', overflow: 'visible', pointerEvents: 'none' }}>
        ...
        <div className="flex justify-between items-start w-[650px] mb-12 z-10 text-[#c5a365]">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <p className="text-xl tracking-widest font-serif mb-2 mt-4">6:00 PM</p>
            <p className="text-[9px] tracking-[0.2em] uppercase opacity-70">Onwards</p>
          </div>
